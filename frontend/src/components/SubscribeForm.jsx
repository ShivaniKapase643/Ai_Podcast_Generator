      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-surface-300 p-5 mb-6 shadow-sm">
        ...
        <div className="flex gap-3">
          ...
          <input type="text" value={name} onChange={(e) => setName(e.target.value)}
            ...
            className="w-40 px-4 py-2.5 bg-surface-50 border border-surface-300 rounded-xl text-sm text-surface-900 placeholder-surface-400 focus:outline-none focus:border-brand focus:ring-2 focus:ring-brand/10" />
          <button type="submit"
            className="flex items-center gap-2 px-5 py-2.5 bg-brand text-white rounded-xl text-sm font-bold hover:bg-brand-dark shadow-sm transition-all">
